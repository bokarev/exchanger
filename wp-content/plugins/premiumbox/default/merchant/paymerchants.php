    ...
    function column_default($item, $column_name){
		...
		if($column_name == 'descr'){
			$html = '
				...
				<div class="active second plugin-version-author-uri">'. __('Version','pn') .': '. pn_strip_input($item['version']) .' | <a href="'. admin_url('admin.php?page=pn_data_paymerchants&m_id='.$item['name']) .'" target="_blank">'. __('Settings','pn') .'</a> '. apply_filters('paymerchants_settingtext_'. $item['name'],'') .'</div>
			';
