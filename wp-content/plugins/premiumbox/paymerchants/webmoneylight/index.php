<?php
/*
title: [ru_RU:]Webmoney Light[:ru_RU][en_US:]Webmoney Light[:en_US]
description: [ru_RU:]авто выплаты Webmoney Light[:ru_RU][en_US:]Webmoney Light automatic payouts[:en_US]
version: 1.2
*/
